...
describe('Swedish progress copy',()=>{
  ...
  it('names the three-modes achievement without implying an exact mode count',()=>expect(achievementCopy({id:'modes-3'})).toEqual({name:'Tre sätt att öva',description:'Använd tre olika övningstyper samma dag.'}));
